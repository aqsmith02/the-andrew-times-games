...
You can write something sweet 💕`,description:"A special poem written just for you"},{level:4,xpRequired:1200,type:"text",title:"Coffee On Me! ☕",content:"This is an IOU for one coffee of your choice - my treat! Redeem anytime 😊",description:"Free coffee whenever you want!"},{level:5,xpRequired:1500,type:"image",path:"rewards/simpsons.png",title:"Another Picture of Me",description:"Another one for your collection! 📸"},{level:6,xpRequired:1800,type:"image",path:"rewards/lil_madison.png",title:"Funny Video",description:"Prepare to laugh 😂"},{level:7,xpRequired:2100,type:"text",title:"Ultimate Embarrassment IOU",content:"I will embarrass myself in ANY way you ask. No limits. You have full control. Use this power wisely... 😰",description:"The ultimate reward - make me do anything!"}];class Z{constructor(){this.load()}load(){const e=localStorage.getItem("gameProgress");if(e){const t=JSON.parse(e);this.totalXP=t.totalXP||0,this.unlockedRewards=t.unlockedRewards||[],this.lastPlayed=t.lastPlayed||{}}else this.totalXP=0,this.unlockedRewards=[],this.lastPlayed={}}save(){localStorage.setItem("gameProgress",JSON.stringify({totalXP:this.totalXP,unlockedRewards:this.unlockedRewards,lastPlayed:this.lastPlayed}))}addXP(e){const t=this.getCurrentLevel();this.totalXP+=e;const o=this.getCurrentLevel();if(this.save(),o>t){const i=[];for(let n=t+1;n<=o;n++)this.unlockedRewards.includes(n)||(this.unlockedRewards.push(n),i.push(k[n-1]));return{leveledUp:!0,newRewards:i}}return{leveledUp:!1}}getCurrentLevel(){for(let e=k.length-1;e>=0;e--)if(this.totalXP>=k[e].xpRequired)return k[e].level;return 0}getNextReward(){const e=this.getCurrentLevel();return k[e]||null}getXPToNextLevel(){const e=this.getNextReward();return e?e.xpRequired-this.totalXP:0}getAllRewards(){return k}getUnlockedRewards(){return k.filter(e=>this.unlockedRewards.includes(e.level))}hasPlayedToday(e){const t=new Date().toDateString();return this.lastPlayed[e]===t}markPlayedToday(e){const t=new Date().toDateString();this.lastPlayed[e]=t,this.save()}getTotalXP(){return this.totalXP}}const u=new Z;class ee{constructor(e){this.container=e,this.questions=z(),this.currentQuestionIndex=0,this.score=0,this.answers=[],this.isComplete=!1,this.levelUpRewards=[],this.loadProgress(),this.render()}loadProgress(){const e=new Date().toDateString(),t=localStorage.getItem("thisOrThat_progress");if(t){const o=JSON.parse(t);if(o.date===e)return this.score=o.score||0,this.answers=o.answers||[],this.currentQuestionIndex=this.answers.length,this.isComplete=o.complete||!1,!0}return!1}saveProgress(e=!1){const t=new Date().toDateString();localStorage.setItem("thisOrThat_progress",JSON.stringify({date:t,complete:e||this.isComplete,score:this.score,answers:this.answers,currentQuestionIndex:this.currentQuestionIndex}))}handleAnswer(e){const t=this.questions[this.currentQuestionIndex],o=e===t.answer;if(this.answers.push({question:t,userChoice:e,correct:o}),o){this.score+=20;const i=u.addXP(20);i.leveledUp&&i.newRewards.length>0&&this.levelUpRewards.push(...i.newRewards)}this.saveProgress(!1),this.showResult(o,t),setTimeout(()=>{this.currentQuestionIndex++,this.currentQuestionIndex>=this.questions.length?this.completeGame():this.render()},1500)}showResult(e,t){const o=this.container.querySelector(".game-content"),i=t.answer==="A"?t.optionA:t.optionB;o.innerHTML=`
    ...
    `,this.container.querySelector(".game-content").innerHTML=o;const i=this.container.querySelector(".review-btn");i&&i.addEventListener("click",()=>this.showReview())}showReview(){const e=`
      <div class="review-screen">
        <h2>Answer Review</h2>
        <div class="review-list">
          ${this.answers.map((o,i)=>`
    ...
    `,this.attachEventListeners()}attachEventListeners(){this.container.querySelectorAll(".choice-btn").forEach(o=>{o.addEventListener("click",i=>{i.preventDefault();const n=o.getAttribute("data-choice");this.handleAnswer(n)})}),this.container.querySelectorAll(".back-btn, .mobile-back-btn").forEach(o=>{o.addEventListener("click",()=>window.showHome())})}}window.thisOrThat=null;function M(s){window.thisOrThat=new ee(s)}function _(s){const e=new Date().toDateString(),t=localStorage.getItem("thisOrThat_progress");if(!t){s.innerHTML=`
      <div class="review-screen">
        <button class="back-btn">← Back</button>
    ...
    `,x(s);return}const o=JSON.parse(t);if(o.date!==e||!o.complete){const n=o.answers?.length||0;s.innerHTML=`
      <div class="review-screen">
        <button class="back-btn">← Back</button>
    ...
    `,x(s);const r=s.querySelector(".continue-btn");r&&r.addEventListener("click",()=>M(s));return}const i=`
    <div class="review-screen">
      <button class="back-btn">← Back</button>
  ...
  `;s.innerHTML=i,x(s)}function x(s){s.querySelectorAll(".back-btn, .mobile-back-btn").forEach(t=>{t.addEventListener("click",()=>window.showHome())})}window.reviewThisOrThat=function(){const s=document.getElementById("app");_(s)};window.startThisOrThatFromMenu=function(){const s=document.getElementById("app");M(s)};function te(s){s.innerHTML=`
    <div class="wordle">
      <div class="grid">
  ...
  `}const G="wordle_progress";function N(s){localStorage.setItem(G,JSON.stringify(s))}function F(){const s=localStorage.getItem(G);return s?JSON.parse(s):null}let b=[],H=new Set,R=!1;const D="/the-andrew-times-games/";function se(s){let e=2166136261;for(let t=0;t<s.length;t++)e^=s.charCodeAt(t),e=Math.imul(e,16777619);return()=>(e+=e<<13,e^=e>>>7,e+=e<<3,e^=e>>>17,e+=e<<5,(e>>>0)/4294967296)}function oe(s,e){const t=se(e),o=[...s];for(let i=o.length-1;i>0;i--){const n=Math.floor(t()*(i+1));[o[i],o[n]]=[o[n],o[i]]}return o}async function ne(){if(!R)try{const[s,e]=await Promise.all([fetch(`${D}wordle-data/answers.json`),fetch(`${D}wordle-data/allowed.json`)]);if(!s.ok||!e.ok)throw new Error("Failed to load word list files");const t=await s.json(),o=await e.json();b=t.map(n=>n.toUpperCase()),b=oe(b,"wordle-v1");const i=o.map(n=>n.toUpperCase());H=new Set([...b,...i]),R=!0,console.log("✅ Word lists loaded:",b.length,"answers,",H.size,"allowed"),console.log("Today's answer:",j())}catch(s){throw console.error("❌ Failed to load word lists:",s),s}}function ie(s){if(!R)return console.warn("Word lists not loaded yet"),!1;const e=s.trim().toUpperCase();return H.has(e)}function j(){if(!R)throw new Error("Word lists not loaded");if(b.length===0)throw new Error("No answers loaded");const s=new Date("2021-06-19"),e=new Date;s.setHours(0,0,0,0),e.setHours(0,0,0,0);const t=Math.floor((e-s)/864e5)%b.length;return b[t]}const $=5,U=6,O=100;async function ae(s){await ne();const e=j(),t=new Date().toDateString(),o=F(),i=o&&o.date===t&&o.answer===e&&!o.won&&o.rowsUsed<U;let n=i?o.rowsUsed:0,r=0,p=i?!1:o&&o.date===t;const m=i?[...o.guesses]:[];s.innerHTML=`
...
${l.description}`})),f(d,h)}else f(`😢 The word was ${e}`);N({date:t,answer:e,won:a,rowsUsed:m.length,guesses:m})}function f(a,c=!1){const d=w.querySelector(".wordle-message");d&&d.remove();const h=document.createElement("div");h.className="wordle-message",c&&h.classList.add("level-up-message"),h.textContent=a,w.appendChild(h)}function P(a){B(a.key.toUpperCase())}window.addEventListener("keydown",P),w.querySelectorAll(".key").forEach(a=>{a.addEventListener("click",()=>B(a.textContent))});function v(){window.removeEventListener("keydown",P)}}function re(s){const e=new Date().toDateString(),t=F();if(!t||t.date!==e){s.innerHTML=`
  ...
  `}const S=[{category:"Nicknames",answers:["beanie","boobie","munt","tony"]},{category:"Favorite 80s Rock Bands",answers:["the smiths","talking heads","misfits","queen"]},{category:"In Your Room",answers:["box fan","john lennon poster","vision board","wallpaper"]},{category:"Food Combos",answers:["ketchup and rice","orange juice and popcorn","weenies and toast","jam and sausage"]},{category:"Road Names",answers:["pickle buddy court","honey girl lane","ruby golightly drive","apple butter drive"]},{category:"Crushes",answers:["cillian murphy","drew starkey","dallas","chris christie"]},{category:"Lead Actors of Movies We Watched",answers:["timothee chalamet","harrison ford","dylan o'brien","jim carrey"]},{category:"My Spotify Wrapped Artists",answers:["radiohead","nat king cole","bobby darin","a tribe called quest"]}],Q="name_four_progress";function le(s){localStorage.setItem(Q,JSON.stringify(s))}function Y(){const s=localStorage.getItem(Q);return s?JSON.parse(s):null}const X=25;function ce(){const s=new Date("2025-01-01"),e=new Date;s.setHours(0,0,0,0),e.setHours(0,0,0,0);const t=Math.floor((e-s)/(1e3*60*60*24));return S[t%S.length]}function de(s){const e=new Date().toDateString(),t=ce(),o=t.answers.map(v=>v.toUpperCase()),i=Y(),n=new Set(i?.date===e?i.found||[]:[]),r=new Set(i?.date===e?i.revealed||[]:[]);let p=i?.date===e&&i.guessCount||0,m=i?.date===e&&i.xpAwarded||0,w=i?.date===e&&i.completed,g=[];s.innerHTML=`
    <div class="name-four">
      <button class="back-btn" id="back-home">← Back</button>
  ...
  `;const A=document.getElementById("guess-input"),T=document.getElementById("answer-grid"),L=document.getElementById("completion-message");document.getElementById("back-home").onclick=()=>window.showHome(),document.getElementById("mobile-back-home").onclick=()=>window.showHome(),B(),w&&P(),document.getElementById("guess-form").onsubmit=v=>{if(v.preventDefault(),w)return;const a=A.value.trim();if(!a)return;const c=a.toUpperCase();if(A.value="",p++,n.has(c)||r.has(c)){y();return}if(o.includes(c)){n.add(c);const d=E();d.leveledUp&&d.newRewards.length>0&&g.push(...d.newRewards),B(),n.size+r.size===4&&f()}y()};function B(){T.innerHTML="",o.forEach(v=>{const a=n.has(v)||r.has(v),c=document.createElement("div");c.className=`answer-box ${a?"solved":""}`;const d=document.createElement("div");if(d.className="answer-text",d.textContent=a?v:v.replace(/[A-Z]/gi,"_"),c.appendChild(d),!a&&!w){const h=document.createElement("button");h.className="reveal-single-btn",h.textContent="Reveal",h.onclick=()=>{r.add(v),B(),n.size+r.size===4&&f(),y()},c.appendChild(h)}T.appendChild(c)})}function E(){return m+=X,u.addXP(X)}function y(v=!1){le({date:e,found:[...n],revealed:[...r],completed:v||w,guessCount:p,xpAwarded:m})}function f(){w=!0,u.markPlayedToday("name-four"),A.disabled=!0,document.querySelector("#guess-form button").disabled=!0,y(!0),P()}function P(){let v=`
    ...
    `,L.innerHTML=v}}function ue(){const s=new Date("2025-01-01"),e=new Date;s.setHours(0,0,0,0),e.setHours(0,0,0,0);const t=Math.floor((e-s)/(1e3*60*60*24));return S[t%S.length]}function he(s){const e=new Date().toDateString(),t=ue(),o=Y();if(!o||o.date!==e){s.innerHTML=`
  ...
  `}const C=document.getElementById("app");function J(){const s=u.getCurrentLevel(),e=u.getTotalXP(),t=u.getXPToNextLevel(),o=u.getNextReward();C.innerHTML=`
  ...
  `}async function ve(s){u.hasPlayedToday(s)?we(s):await pe(s)}async function pe(s){C.innerHTML='<div id="game-container"></div>';const e=document.getElementById("game-container");s==="thisOrThat"&&M(e),s==="wordle"&&await ae(e),s==="name-four"&&de(e)}function we(s){C.innerHTML='<div id="game-container"></div>';const e=document.getElementById("game-container");s==="thisOrThat"&&_(e),s==="wordle"&&re(e),s==="name-four"&&he(e)}function me(){const s=u.getUnlockedRewards(),e=u.getAllRewards();C.innerHTML=`
